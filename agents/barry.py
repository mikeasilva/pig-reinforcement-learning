...
class Player:
    # Barry a player that makes a decision based on probabilities on the
    # action to take based on the points at risk.  Instead of flipping a biased
    # coin though he goes for the most likely.
    name = "Barry"
    is_learner = True
